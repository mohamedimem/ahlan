  ...
  Future<List<AjouterAlimentArguments>> loadItemsFromSharedPreferences() async {
    ...
    if (itemList != null) {
      List<AjouterAlimentArguments> decodedList = itemList.map((item) {
        ...
        return AjouterAlimentArguments(decodedItem['name'],
            decodedItem['quantity'], decodedItem['quantity2']);
      }).toList();
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(
                            item.quantity.toString() + ' Glicide(gr)',
                            style: TextStyle(
                                color:
                                    Colors.black), // Set the desired text color
                          ),
                          Text(
                            item.lipides.toString() + ' Lipides',
                            style: TextStyle(
                                color:
                                    Colors.black), // Set the desired text color
                          ),
